...
export default function Ark() {
  ...
  <div className=" border-gray-400 rounded-lg overflow-hidden">
    <h3 className="bg-[#4D6C9D] h-[61px]  text-[32px] text-center py-2 font-bold">OD</h3>

    <div className="p-4">
      {/* First Row */}
      <div className="grid grid-cols-5 gap-2 text-sm">
        <div>
          <label className="block text-xl text-gray-700 mb-1">K1</label>
          <input className="p-2 rounded-2xl bg-[#FFFFFFE0]  w-full" />
        </div>
        <div>
          <label className="block text-xl text-gray-700 mb-1">R1</label>
          <input className="p-2  rounded-2xl bg-[#FFFFFFE0] w-full" />
        </div>
        <div>
          <label className="block text-xl text-gray-700 mb-1">AXIS</label>
          <input className="p-2 rounded-2xl bg-[#FFFFFFE0] w-full" />
        </div>
        <div>
          <label className="block text-xl text-gray-700 mb-1">AXL</label>
          <input className="p-2  rounded-2xl bg-[#FFFFFFE0] w-full" />
        </div>
        <div>
          <label className="block text-xl text-gray-700 mb-1">PCIOL</label>
          <input className="p-2  rounded-2xl bg-[#FFFFFFE0] w-full" />
        </div>
      </div>
  ...
  <div className="  rounded-2xl overflow-hidden">
    <h3 className="bg-[#4D6C9D] h-[61px] text-[32px]  text-center py-2 font-bold">OS</h3>
