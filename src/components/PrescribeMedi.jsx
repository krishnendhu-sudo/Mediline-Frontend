...
const PrescribeMedi = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center items-start pt-20">
      ...
      {/* Modal content */}
      <div className="relative z-10 w-full max-w-8xl p-4 md:p-6 space-y-6 bg-white rounded-2xl overflow-y-auto max-h-[90vh]">
        {/* Header */}
        ...
        {/* Inputs Section */}
        <div className="p-4 md:p-6 bg-[#CBDCEB] rounded-2xl space-y-6">
          {/* Row 1 */}
        ...
        <div className="flex justify-end mt-4 space-x-4">
          ...
          <button className="bg-red-500 text-white px-4 md:px-6 py-2 rounded-full flex items-center gap-2 hover:bg-red-600 text-sm md:text-base" onClick={onClose}>
            Cancel
          </button>
        </div>
        ...
        <div className="p-10 overflow-x-auto">
          <table className="w-full rounded-lg text-sm md:text-base">
            <thead className="bg-black text-white">
              <tr>
                {["MEDICINE","DOSAGE","DURATION","QUANTITY","ROUTE","START DATE","END DATE"].map((head) => (
        ...
        <div className="flex justify-between items-center border-t pt-3">
          ...
          <div className="flex gap-3">
            <button className="bg-red-500 text-white px-4 py-2 rounded-full hover:bg-gray-500 text-sm md:text-base" onClick={onClose}>
              Close
            </button>
